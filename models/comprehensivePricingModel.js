      ...
      carCab: {
        ...
        vehicleTypes: {
          economy: {
            ...
            // Optional per-vehicle night charges
            nightCharges: {
      ...
      carRecovery: {
            ...
            driverOptions: {
              ...
              startOvertimeCharges: {
                ...
                description: {
                  type: String,
                  default:
                    "Driver wants the system to begin charging the customer",
                },
              },
            },
            failsafeCondition: {
        ...
        serviceTypes: {
          ...
          keyUnlockerServices: {
            ...
            // Optional category-level overrides
            baseFare: {
              amount: { type: Number, default: 0 },
              coverageKm: { type: Number, default: 0 },
            },
        ...
        refreshmentAlert: {
          ...
          driverOptions: {
            ...
            startOvertimeCharges: {
              type: String,
              default: "Start Overtime Charges",
            },
          },
          failsafeCondition: {
        ...
        questions: [
          {
            question: {
              type: String,
              default: "How was your experience with [Service Provider Name]?",
            },
            options: [
              { type: String, default: "Good" },
              { type: String, default: "Bad" },
              { type: String, default: "Didn't Visit" },
            ],
          },
        ],
        ...
        questions: [
          {
            question: {
              type: String,
              default: "How was [Customer Name]? Behavior?",
            },
            options: [
              { type: String, default: "Good" },
              { type: String, default: "Bad" },
              { type: String, default: "Didn't Meet Yet" },
            ],
          },
        ],
        ratingRequired: { type: Boolean, default: true },
